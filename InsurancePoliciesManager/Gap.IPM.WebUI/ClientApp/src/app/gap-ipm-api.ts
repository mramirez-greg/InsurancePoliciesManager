...
export interface ICustomersInsurancePoliciesClient {
    get(): Observable<CustomerInsurancePolicyListVm>;
    create(command: CreateCustomerInsurancePolicyCommand): Observable<number>;
    update(id: number, command: UpdateCustomerInsurancePolicyCommand): Observable<FileResponse>;
}

@Injectable({
    providedIn: 'root'
})
export class CustomersInsurancePoliciesClient implements ICustomersInsurancePoliciesClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    get(): Observable<CustomerInsurancePolicyListVm> {
        let url_ = this.baseUrl + "/api/CustomersInsurancePolicies";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CustomerInsurancePolicyListVm>><any>_observableThrow(e);
                }
            } else
                return <Observable<CustomerInsurancePolicyListVm>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<CustomerInsurancePolicyListVm> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CustomerInsurancePolicyListVm.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CustomerInsurancePolicyListVm>(<any>null);
    }
    ...
    update(id: number, command: UpdateCustomerInsurancePolicyCommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/CustomersInsurancePolicies/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
...
export class CustomerInsurancePolicyListVm implements ICustomerInsurancePolicyListVm {
    customerInsurancePolicies?: CustomerInsurancePolicyLookupDto[] | undefined;

    constructor(data?: ICustomerInsurancePolicyListVm) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["customerInsurancePolicies"])) {
                this.customerInsurancePolicies = [] as any;
                for (let item of _data["customerInsurancePolicies"])
                    this.customerInsurancePolicies!.push(CustomerInsurancePolicyLookupDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): CustomerInsurancePolicyListVm {
        data = typeof data === 'object' ? data : {};
        let result = new CustomerInsurancePolicyListVm();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        if (Array.isArray(this.customerInsurancePolicies)) {
            data["customerInsurancePolicies"] = [];
            for (let item of this.customerInsurancePolicies)
                data["customerInsurancePolicies"].push(item.toJSON());
        }
        return data; 
    }
}

export interface ICustomerInsurancePolicyListVm {
    customerInsurancePolicies?: CustomerInsurancePolicyLookupDto[] | undefined;
}

export class CustomerInsurancePolicyLookupDto implements ICustomerInsurancePolicyLookupDto {
    customerInsurancePolicyId?: number;
    customerId?: string | undefined;
    customerName?: string | undefined;
    insurancePolicyId?: number;
    insurancePolicyName?: string | undefined;
    status?: CustomerInsurancePolicyStatus;
    statusName?: string | undefined;
    statusDate?: Date;

    constructor(data?: ICustomerInsurancePolicyLookupDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.customerInsurancePolicyId = _data["customerInsurancePolicyId"];
            this.customerId = _data["customerId"];
            this.customerName = _data["customerName"];
            this.insurancePolicyId = _data["insurancePolicyId"];
            this.insurancePolicyName = _data["insurancePolicyName"];
    ...
    static fromJS(data: any): CustomerInsurancePolicyLookupDto {
        data = typeof data === 'object' ? data : {};
        let result = new CustomerInsurancePolicyLookupDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["customerInsurancePolicyId"] = this.customerInsurancePolicyId;
        data["customerId"] = this.customerId;
        data["customerName"] = this.customerName;
        data["insurancePolicyId"] = this.insurancePolicyId;
        data["insurancePolicyName"] = this.insurancePolicyName;
...
export interface ICustomerInsurancePolicyLookupDto {
    customerInsurancePolicyId?: number;
    customerId?: string | undefined;
    customerName?: string | undefined;
    insurancePolicyId?: number;
...
export enum CustomerInsurancePolicyStatus {
    Asignado = 0,
    Cancelado = 1,
}

export class CreateCustomerInsurancePolicyCommand implements ICreateCustomerInsurancePolicyCommand {
    customerId?: string | undefined;
    insurancePolicyId?: number;
    status?: CustomerInsurancePolicyStatus;

    constructor(data?: ICreateCustomerInsurancePolicyCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateCustomerInsurancePolicyCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateCustomerInsurancePolicyCommand();
        result.init(data);
        return result;
    }
...
export interface ICreateCustomerInsurancePolicyCommand {
    customerId?: string | undefined;
    insurancePolicyId?: number;
    status?: CustomerInsurancePolicyStatus;
}

export class UpdateCustomerInsurancePolicyCommand implements IUpdateCustomerInsurancePolicyCommand {
    customerInsurancePolicyId?: number;
    status?: CustomerInsurancePolicyStatus;

    constructor(data?: IUpdateCustomerInsurancePolicyCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateCustomerInsurancePolicyCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateCustomerInsurancePolicyCommand();
        result.init(data);
        return result;
    }
...
export interface IUpdateCustomerInsurancePolicyCommand {
    customerInsurancePolicyId?: number;
    status?: CustomerInsurancePolicyStatus;
}
...
export class InsurancePolicyLookupDto implements IInsurancePolicyLookupDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.riskTypeName = _data["riskTypeName"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["riskTypeName"] = this.riskTypeName;
        return data; 
    }
}
